...
Sistema=135
timeo=time.time()
Objeto=OPEND.DSS(r"[C:\Users\Windows 10\Downloads\codigos\135Barras.dss]")
Objeto.compile_DSS()
...
Nombre_xlsx='Resultados '+str(Sistema)+'B_clasico_'+'.xlsx'
...
plt.grid()
#plt.show()
nombre=str(Sistema)+'B_clasico_'+'T'+'.pdf'
plt.savefig(nombre, dpi=300, bbox_inches='tight')
nombre=str(Sistema)+'B_clasico_'+'T'+'.png'
plt.savefig(nombre, dpi=300, bbox_inches='tight')
...
plt.grid()
#plt.show()
nombre=str(Sistema)+'B_clasico_'+'FOm'+'.pdf'
plt.savefig(nombre, dpi=300, bbox_inches='tight')
nombre=str(Sistema)+'B_clasico_'+'FOm'+'.png'
plt.savefig(nombre, dpi=300, bbox_inches='tight')
...
plt.grid()
#plt.show()
nombre=str(Sistema)+'B_clasico_'+'FOact'+'.pdf'
plt.savefig(nombre, dpi=300, bbox_inches='tight')
nombre=str(Sistema)+'B_clasico_'+'FOact'+'.png'
plt.savefig(nombre, dpi=300, bbox_inches='tight')