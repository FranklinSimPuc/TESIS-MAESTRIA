...
alpha2= 0.9   #Constate lenta geométrica
Klm=4  # Multiplicador de N° de veces las iteraciones para Lundy & Mees
Tlm=0.10  # Temperatura inicial para Lundy & Mees: Tlm es porcentaje de To
