...
Nombre_xlsx='Resultados '+str(Sistema)+'B_1Corrida_Clasico_Adap'+'.xlsx'
...
plt.grid()
#plt.show()
nombre=str(Sistema)+'B_1Corrida_Clasico_Adap_'+'T'+'.pdf'
plt.savefig(nombre, dpi=300, bbox_inches='tight')
nombre=str(Sistema)+'B_1Corrida_Clasico_Adap_'+'T'+'.png'
plt.savefig(nombre, dpi=300, bbox_inches='tight')
...
plt.grid()
#plt.show()
nombre=str(Sistema)+'B_1Corrida_Clasico_Adap_'+'FOm'+'.pdf'
plt.savefig(nombre, dpi=300, bbox_inches='tight')
nombre=str(Sistema)+'B_1Corrida_Clasico_Adap_'+'FOm'+'.png'
plt.savefig(nombre, dpi=300, bbox_inches='tight')
...
plt.grid()
#plt.show()
nombre=str(Sistema)+'B_1Corrida_Clasico_Adap_'+'FOact'+'.pdf'
plt.savefig(nombre, dpi=300, bbox_inches='tight')
nombre=str(Sistema)+'B_1Corrida_Clasico_Adap_'+'.png'
plt.savefig(nombre, dpi=300, bbox_inches='tight')