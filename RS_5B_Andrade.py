...
Nombre_xlsx='Resultados '+str(Sistema)+'B_Andrade_'+'.xlsx'
...
plt.grid()
#plt.show()
nombre=str(Sistema)+'B_Andrade_'+'T'+'.pdf'
plt.savefig(nombre, dpi=300, bbox_inches='tight')
nombre=str(Sistema)+'B_Andrade_'+'T'+'.png'
plt.savefig(nombre, dpi=300, bbox_inches='tight')
...
plt.grid()
#plt.show()
nombre=str(Sistema)+'B_Andrade_'+'FOm'+'.pdf'
plt.savefig(nombre, dpi=300, bbox_inches='tight')
nombre=str(Sistema)+'B_Andrade_'+'FOm'+'.png'
plt.savefig(nombre, dpi=300, bbox_inches='tight')
...
plt.grid()
#plt.show()
nombre=str(Sistema)+'B_Andrade_'+'FOact'+'.pdf'
plt.savefig(nombre, dpi=300, bbox_inches='tight')
nombre=str(Sistema)+'B_Andrade_'+'FOact'+'.png'
plt.savefig(nombre, dpi=300, bbox_inches='tight')