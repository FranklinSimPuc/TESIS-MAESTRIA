...
max_RepFO = 12 #Número máximo de repeticiones de la FO
...
Nombre_xlsx='Resultados '+str(Sistema)+'B_C_'+str(C)+'.xlsx'
...
plt.grid()
#plt.show()
nombre=str(Sistema)+'B_C'+str(C)+'T'+'.pdf'
plt.savefig(nombre, dpi=300, bbox_inches='tight')
nombre=str(Sistema)+'B_C'+str(C)+'T'+'.png'
plt.savefig(nombre, dpi=300, bbox_inches='tight')
...
plt.grid()
#plt.show()
nombre=str(Sistema)+'B_C'+str(C)+'FOm'+'.pdf'
plt.savefig(nombre, dpi=300, bbox_inches='tight')
nombre=str(Sistema)+'B_C'+str(C)+'FOm'+'.png'
plt.savefig(nombre, dpi=300, bbox_inches='tight')
...
plt.grid()
#plt.show()
nombre=str(Sistema)+'B_C'+str(C)+'FOact'+'.pdf'
plt.savefig(nombre, dpi=300, bbox_inches='tight')
nombre=str(Sistema)+'B_C'+str(C)+'FOact'+'.png'
plt.savefig(nombre, dpi=300, bbox_inches='tight')